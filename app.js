...
(() => {
  ...
  function renderHome(favorites=false) {
    ...
    <div class="stats-row"><div class="stat"><strong>07</strong><span>classifications<br>essentielles</span></div><div class="stat"><strong>10</strong><span>parcours de<br>référence</span></div><div class="stat"><strong>${String(state.favorites.size).padStart(2,'0')}</strong><span>guides épinglés<br>dans vos favoris</span></div></div>`:''}
